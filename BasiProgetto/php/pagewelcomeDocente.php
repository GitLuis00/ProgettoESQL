...
<head>
    ...
    <title>ESQL - Dashboard Docente</title>
...
<body>
    ...
    <div class="main">
        <div class="content">
            ...
            <div class="actions">
                <p>Per <b style="color:green">visualizzare e creare i test</b>:</p>
                <input id="pulsante" type='button' value='→' onclick="location.href='visualizzaTestDocente.php'"/>
                <p>Per la <b style="color:green">sezione messaggi</b>:</p>
                <input id="pulsante" type='button' value='→' onclick="location.href='pageVisualizzaMessaggiDocente.php'"/>
            </div>
        </div>
    </div>
</body>
